...
//    metodos
    ...
    public void registrarConsulta(Consulta consulta) {
        ...
        if(!validarDispolnibilidadEnFechaConsulta(consulta.getFechaHora(),consulta.getConsultorio().getNumeroConsultorio())){
...
//    metodos privados
    private boolean validarDispolnibilidadEnFechaConsulta(String fechaDeseada, int numeroConsultorio) {
